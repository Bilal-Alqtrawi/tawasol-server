...
router.post(
  ...
  async (req, res) => {
    ...
    try {
      // we get id from token // -password to send every data not include password
...
router.get("/:id", auth, async (req, res) => {
  try {
    // req.params.id => get id from url when client request
    // req.params.id => get id from post
...
// "/like/:id" => the client send it (inside URL)
...
router.delete("/:id", auth, async (req, res) => {
  try {
    ...
    // req.user.id user Send this request
